...
export const RANDOM_PERSONALITIES = [
  ...
  "A disaster in a nice outfit. Means well, tries hard, and somehow survives every situation through sheer audacity.",
  "Quiet observer with a sharp wit. Notices everything, says little, and has a comeback for every occasion.",
  "Sunshine mixed with a little hurricane. Will hold your hand in public and then challenge you to a duel.",
  "Professional clown on the outside, hopeless romantic on the inside. Uses humor as a shield and it almost works.",
  "Old soul in a young body. Drinks tea, reads physical books, and falls asleep by 9pm on purpose.",
];
...
export const RANDOM_APPEARANCES = [
  ...
  "Rugged and well-worn, like a favorite book. Calloused hands, warm smile, and clothes that have seen better days.",
  "Sleek and polished, always put together. Looks like they stepped out of a magazine but their eyes tell a different story.",
  "Wild and untamed, a mess of curls and confidence. Wears whatever makes them feel powerful today.",
  "Delicate and precise, every detail intentional. From their haircut to their shoes, nothing is accidental.",
  "Built like a protector, gentle like a poet. Strong hands that write love letters and throw punches equally well.",
];
...
export const RANDOM_BACKSTORIES = [
  ...
  "Born in a war, raised in a library. Knows how to throw a punch and write a sonnet with equal skill.",
  "Stole a starship at sixteen and never looked back. Now they deliver cargo across the galaxy and avoid getting attached.",
  "Once a prodigy, now a dropout. Left the academy to find their own path and ended up in places they never planned.",
  "Survived a plague that took everyone they loved. Now they collect stories from strangers to keep the memories alive.",
  "Woke up with no memory in a city that never sleeps. Every day is a puzzle and every person is a clue.",
];
...
export const RANDOM_TRUTHS = [
  ...
  "I once fell in love with someone I met in a dream.",
  "I collect broken things and fix them when no one is watching.",
  "I have a scar from a fight I started over a stranger.",
  "I still sleep with a stuffed animal and I am not sorry.",
  "I memorize constellations to feel less alone.",
];
...
export const RANDOM_LIES = [
  ...
  "I have never lied to someone I care about.",
