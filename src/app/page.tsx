...
const MOBILE_OFFSETS: Record<string, number> = {
  ...
  "/headers/Sky.avif": 50,
  "/headers/SnowyPass.avif": 85,
  "/headers/Spirits.avif": 60,
  "/headers/Study.avif": 70,
  "/headers/Tavern.avif": 90,
  "/headers/Underwater.avif": 80,
  "/headers/InfinityPoolPenthouse.avif": 45,
  "/headers/LuxSofa.avif": 75,
};
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-between px-4 py-4 md:px-6 md:py-5">
              ...
              <div className="relative mt-4 w-full max-w-2xl sm:mt-0">
                ...
                <div className="relative flex flex-wrap justify-start gap-2 sm:flex sm:justify-start sm:gap-3">
                  <StatCard
                    icon={Users}
                    label="Characters"
